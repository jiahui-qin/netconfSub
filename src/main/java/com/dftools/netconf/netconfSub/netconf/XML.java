...
public class XML {
     ...
     *
     * @param element The name of element to append.
     ...
     *
     * @param element The name of element to append.
     * @param text    The text value of the element to be appended
     * @return The modified XML after appending the element.
     */
     ...
     *
     * @param element The name of elements to append.
     * @param text    The array containing text value for each element.
     */
     ...
     *
     * @param map The map of each entry containing element name as the key and
     ...
     *
     * @param element The name of the element to be appended.
     * @param map     The map of each entry containing element name as the key and
     *                text value as the key value.
     * @return The modified XML after appending the element.
     */
     ...
     *
     * @param element The name of the new element to be added.
     */
     ...
     * object.
     *
     * @param element The name of element to add.
     * @param text    The text value of the element to be appended.
     */
     ...
     *
     * @param element The name of elements to add.
     * @param text    The array containing text value for each element.
     */
     ...
     * active element.
     *
     * @param path The path to be added. For example, to add the hierarchy:
     *             &lt;a&gt;
     *             &lt;b&gt;
     *             &lt;c/&gt;
     *             &lt;/b&gt;
     ...
     *
     * @param list The String based list of elements which determine the hierarchy.
